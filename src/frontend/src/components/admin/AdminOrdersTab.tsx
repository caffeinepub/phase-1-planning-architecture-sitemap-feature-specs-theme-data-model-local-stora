...
import AdminOrderTrackingDetailModal from './AdminOrderTrackingDetailModal';
import { TRACKING_STATUS_LABELS, type TrackingStatus, type OrderWithTracking } from '../../types/orderTracking';
...
export default function AdminOrdersTab() {
  ...
  const filteredOrders = useMemo(() => {
    return orders.filter((order: OrderWithTracking) => {
  ...
  const handleViewTracking = (order: OrderWithTracking) => {
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge className="bg-arcane-gold/20 text-arcane-gold border-arcane-gold/30">
                        {TRACKING_STATUS_LABELS[order.tracking.currentStatus as TrackingStatus]}
                      </Badge>
